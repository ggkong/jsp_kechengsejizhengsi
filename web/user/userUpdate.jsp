...
<form action="${pageContext.request.contextPath}/user/updateUser" method="post">
    <div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="#" style="color: #ffffff">修改用户</a></li>
        </ul>
    </div>
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li>
                ...
                </label><input name="account" type="text" class="scinput" value="${userWillUpdate.account}" readonly="readonly"/></li>
            <li>
                <label>密码 <font color="red">*</font></label>
                <input name="ps" type="password" class="dfinput" value="${userWillUpdate.password}"/>
            </li>
            <li>
            ...
            <li>
                ...
                </label><input name="name" type="text" class="dfinput" value="${userWillUpdate.name}"/>
            </li>
            <li><label>部门</label>
                <div class="vocation">
            ...
            <li>
                ...
                <cite>
                    <c:choose>
                        <c:when test="${userWillUpdate.sex eq '1'}">
            ...
            <li><label>手机号码 <font color="red">*</font></label><input name="mobile" type="text" class="dfinput" value="${userWillUpdate.mobile}" /></li>
            <li><label>出生日期</label>
                <input name="birthday" type="text" class="dfinput" value="${userWillUpdate.birthday}" onClick="WdatePicker({work_date:'',dateFmt:'yyyy-MM-dd'})"/></li>
            <li><label>邮箱 <font color="red">*</font></label><input name="email" type="text" class="dfinput" value="${userWillUpdate.email}" /></li>
            <li><label>&nbsp;</label><input name="" type="button" onclick="saveButton()" class="btn" value="确认修改&提交"/></li>
        </ul>
    </div>
</form>
</body>

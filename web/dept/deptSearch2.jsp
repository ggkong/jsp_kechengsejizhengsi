            ...
            <form action="${pageContext.request.contextPath}/dept/delmanydept" method="post">
                <tbody>
                    <tr>
                        ...
                        <td>${selectDept.departmentId}</td>
                        <td>${selectDept.departmentName}</td>
                        <td>${selectDept.managerName}</td>
                        <td>${selectDept.total_user}</td>
                        <td>${selectDept.createTime}</td>
                        <td><span>
                            <div class="layui-btn-group">
                                <a href="${pageContext.request.contextPath}/dept/updateDept?departmentId=${dept.departmentId}" class="tablelink"><button type="button" class="layui-btn layui-btn-sm"><i class="layui-icon">修改</i></button></a>
                            <a href="/dept/delDept?departmentId=${dept.departmentId}&managername=${dept.managerName}" class="tablelink" onclick="confirm('确定要删除吗？')"> <button type="button" class="layui-btn layui-btn-sm"><i class="layui-icon">删除</i></button></a>
                            </div>

...
<head>
    ...
    <title>公司员工考勤管理平台</title>
    <link href="css/styleslogin.css" rel="stylesheet" type="text/css" />
    <link href="css/demologin.css" rel="stylesheet" type="text/css" />
    <link href="css/loaderslogin.css" rel="stylesheet" type="text/css" />
</head>
...
<div class='login'>
    <div class='login_title'>
        <span>公司员工考勤管理平台</span>
    </div>
    <p style=" color: red; text-align: center">${errorMassage}</p>
    <form action="${pageContext.request.contextPath}/login" method="post">
        <div class='login_fields'>
            <div class='login_fields__user'>
                ...
                <input name="account" placeholder='用户名' maxlength="16" type='text' autocomplete="off" value="${cookie.account.value}" />
            ...
            <div class='login_fields__password'>
                ...
                <input name="password" type = "password" placeholder='密码' value="${cookie.password.value}" maxlength="16" type='text' autocomplete="off">
                <div class='validation'>
                    <img alt="" src='img/tick.png'>
                </div>
            </div>
            <div class='login_fields__verification'>
                <div class="left">
                    <div class='icon'>
                        <img alt="" src='img/key.png'>
                    </div>
                    <input class="input" name="checkCode" placeholder='验证码' maxlength="16" type='text' autocomplete="off">
                    <div class='validation'>
                        <img alt="" src='img/tick.png'>
                    </div>

                    <div class="check01" style="margin-left: 30px">
                        <label><input name="flag" type="checkbox" value="" />记住密码</label>
                    </div>

                </div>
                <div class="right">
                    <a href="javascript:reloadCode();">
                        <img class="yanzhengma" id="imagecode" src="${pageContext.request.contextPath}/servlet/ImageServlet" alt="">
                    </a>
                </div>
            </div>
            <div class='login_fields__submit'>
                ...
                <br>
                <!--					<input type="checkbox" name="remember_psw" id="rem_psw" >记住密码-->
            </div>
        </div>
    </form>
    ...
    <div class='disclaimer' style="text-align: center" >
        <a  href="http://beian.miit.gov.cn/">鲁ICP备2020040090号</a>
    </div>
</div>
...
<%--&lt;%&ndash;    <link href="./css/styleslogin.css" rel="stylesheet" type="text/css" />&ndash;%&gt;--%>
<%--&lt;%&ndash;    <link href="./css/demologin.css" rel="stylesheet" type="text/css" />&ndash;%&gt;--%>
<%--&lt;%&ndash;    <link href="./css/loaderslogin.css" rel="stylesheet" type="text/css" />&ndash;%&gt;--%>
...
<%--            <div class="loginbox">--%>
<%--                <ul>--%>
<%--                    <li><input name="account" type="text" class="loginuser" value="<%=account%>" /></li>--%>
<%--                    <li><input name="password" type="password" class="loginpwd" value="<%=password%>" /></li>--%>
<%--                    <li><input name="checkCode" type="text" class="loginuser" />--%>
<%--                        <a href="javascript:reloadCode();">--%>
...
<%--                        <label><input name="flag" type="checkbox" value="" checked="checked" />记住密码</label>--%>
<%--                    </li>--%>
